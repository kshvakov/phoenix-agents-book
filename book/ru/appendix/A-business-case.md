...
**Как будем снижать риски:** ограничения (guardrails), условия остановки, планы проверки, минимальные привилегии (least privilege), аудит действий (audit trail), eval-набор и эталонные тесты (golden tests).
