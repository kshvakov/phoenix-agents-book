...
- **Митигации:** ревью человеком, разрешённый список действий, консервативная эскалация при неопределённости, сухой прогон плейбука (`--check`) + канареечная/постепенная выкатка (`serial`) + план отката, аварийный выключатель
