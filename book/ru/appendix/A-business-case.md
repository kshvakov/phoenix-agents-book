...
- **Митигации:** ревью человеком, разрешённый список действий, консервативная эскалация при неопределённости, сухой прогон (dry‑run) плейбука (`--check`) + канареечный/постепенный rollout (`serial`) + план отката (rollback), аварийный выключатель (kill switch)
