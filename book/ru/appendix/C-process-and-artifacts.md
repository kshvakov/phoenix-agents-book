...
Дополнение: если вы используете “skills” как формат переносимых процедур, логика та же — навыки должны жить в Git и проходить ревью, потому что это часть производственного процесса (инструкции, шаблоны, проверки), а не “заметки в чате”.
