...
- **Термины и “контракт исполнения” (1 минута, чтобы не путаться)**  
  ...
  - **TRACE:** где видно, на чём “стоял” ответ: какие правила/`SKILL.md`/артефакты реально были использованы. Практика: TRACE кладём рядом с основным артефактом (ответ/`decision packet`) и прикладываем в тикет/PR как evidence.  
