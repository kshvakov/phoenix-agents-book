...
Lance открывает IDE-агент и формулирует промпт:
...
Lance отвечает: "Да. План верификации прилагается. Проверено на выборке — совпадение. Хочешь проверить больше — вот список ID для выборочной проверки."
...
- Lance открывает IDE-агент, пишет промпт:
  ```
