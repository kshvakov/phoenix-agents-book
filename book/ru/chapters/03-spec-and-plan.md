...
### Как сделать план “делегируемым” (handoff‑контракт для подзадач)
...
Практическое правило: если задачу можно отдать “воркеру” (специализированному агенту), она должна быть **самодостаточной** и **проверяемой**.
...
- **Входы**: конкретные артефакты (файлы/ссылки/фрагменты ТЗ/таблицы), без “посмотри репозиторий”.
