...
См. как пример реализации принципа “start with plans” и “starting over from a plan”: [Cursor: Best practices for coding with agents](https://cursor.com/blog/agent-best-practices).
