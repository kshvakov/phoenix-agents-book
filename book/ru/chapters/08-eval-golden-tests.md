...
- Bill Palmer (2014): измерение качества субъективно, tracking нет, защиты от регрессий нет
- С eval-набором (2026): точность (accuracy) 90%, TTRC <TTRC_SECONDS>; tracking улучшений есть; golden tests блокируют деплой при регрессии
