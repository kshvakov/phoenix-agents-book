...
- До SOP (2014): время изменения 4-6 hours (Brent), Bus factor 1, воспроизводимость 0%
- После SOP (2026): время изменения 1 hour (агент + SOP), Bus factor 3+, воспроизводимость 95%
