...
## Главный контракт: пакет решения (decision packet) вместо “простыни диалога”
...
См. «место правды» для минимального контракта: [Приложение C — пакет решения (decision packet): минимальный контракт]({{< relref "appendix/C-process-and-artifacts.md" >}}#decision-packet-contract).
