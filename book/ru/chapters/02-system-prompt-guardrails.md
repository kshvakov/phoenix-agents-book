...
Практическая договорённость: TRACE фиксируется рядом с основным артефактом (ответ/`decision packet`) и уходит в тикет/PR как evidence — чтобы по одной ссылке было видно и решение, и “на чём оно стояло”.
