...
description: "Как превратить разовый промпт в роль с ограничениями: ограничения, условия остановки и воспроизводимый SOP диалога."
lastmod: 2026-01-22
weight: 2
---
...
Такой подход хорошо сочетается с концепцией «навыки» как пакетов знаний: агент держит “витрину” доступных навыков (короткие описания), а подробные инструкции подтягивает по требованию и отражает в TRACE.[^agentskills-integrate]
