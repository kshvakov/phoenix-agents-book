...
- Least privilege by default: write‑операции только через отдельный “executor” контур с явным подтверждением человека
````
...
- MTTR > <WINDOW> (по сравнению с базовым уровнем < <WINDOW>)
