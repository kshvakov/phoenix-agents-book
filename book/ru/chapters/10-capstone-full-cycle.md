...
- D6: собрать eval dataset + golden tests и включить в CI.
...
### Артефакт: eval dataset + golden tests
...
- Eval dataset и golden tests встроены в CI.
...
5. **Не строить контур качества**  
   ...
   - Лекарство: eval dataset + golden tests + алерты на регрессии.
...
3. Соберите `eval dataset` из прошлых кейсов и добавьте 3–5 `golden tests` для критичных.
